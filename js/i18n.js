...
window.I18N = {
  en: {
    ...
    winningYaku:     'Winning Yaku',
    pointBreakdown:  'Point Breakdown',
    baseYakuPts:     'Base Yaku Points',
    finalRoundPts:   'Final Round Points',
    wonBy:           'Won by',
    pts_label:       'pts',
    noYaku:          'No yaku yet',
    ...
    clickFlipDeck:   'Click the deck to flip a card',
    aiKoiKoiDeclared:'Computer says Koi-Koi and continues.',
    aiShobuDeclared: 'Computer declares Shobu.',
    declaredKoiKoi:  'declares Koi-Koi',
    declaredShobu:   'declares Shobu',
  ...
  jp: {
    ...
    clickFlipDeck:   '山札をクリックしてカードをめくってください',
    aiKoiKoiDeclared:'コンピューターは「こいこい」を宣言して続行しました。',
    aiShobuDeclared: 'コンピューターは「勝負」を宣言しました。',
    declaredKoiKoi:  'は「こいこい」を宣言',
    declaredShobu:   'は「勝負」を宣言',
